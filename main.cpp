...
#include <iostream>
#include <tlhelp32.h>
#include "heximage.h" //File ÃÙ»ÀÒ¾ ÁÒ¨Ò¡ Hex ¨Ò¡â»Ãá¡ÃÁ Hxd
...
BOOL DetectByTitle(HWND hWnd) {
    ...
    //ÊÒÁÒÃ¶à¾ÔèÁ Title ·ÕèµéÍ§¡ÒÃ Detect ä´éµÃ§¹Õé
    return FALSE;  
}
bool IsCheatProcessRunning(HWND hWnd) {
    const char* cheatProcesses[] = {
        ...
        xorstr_("ida64.exe"),
        xorstr_("processhacker.exe") //ÊÒÁÒÃ¶à¾ÔèÁâ»Ãá¡ÃÁ·ÕèµéÍ§¡ÒÃ Detect ä´éµÃ§¹Õé
    };
